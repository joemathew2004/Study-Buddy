...
function handleRegister() {
    ...
    registerUser(name, userClass, password);
}
...
function handleLogin() {
    ...
    loginUser(name, userClass, password);
}

// Function to register a new user
async function registerUser(name, userClass, password) {
    try {
...
async function loginUser(name, userClass, password) {
    try {
